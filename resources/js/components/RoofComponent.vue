    ...
    <div class="container h-100 w-100">
        <div class="row h-100 w-100 d-flex flex-column justify-content-center align-items-center wrapper">
            ...
            <div class="flush d-flex flex-row">
                <div>
                    <div>
                        <label for="length">1<sup>st</sup> flush depth</label>
                ...
                <div>
                    ...
                    <input type="text" :value="flush" disabled>m<sup>3</sup>
                </div>
            </div>
            <div class="type text-center">
                ...
                <div class="d-flex flex-row sel">
                    ...
                    <input type="text" disabled :value="coefficient">
                </div>
