    ...
    <div class="container h-100 w-100">
        <div class="row h-100 w-100 d-flex flex-column justify-content-center align-items-center wrapper">
            ...
            <div class="d-flex flex-row form">
                ...
                <div>
                    <label for="person" class="d-flex justify-content-center">Number of Person</label><br>
                    <div class="d-flex justify-content-center align-items-center">
                        <img src="images/minus.png" height="20" alt="" @click="minus">
                        <span v-for="x in person" :key="x.id"><img src="images/user-green.png" height="40" alt=""></span>
                        <img src="images/plus.png" height="20" alt="" @click="add">
                    </div>
                    <small class="d-flex justify-content-center">{{person.length}} person<span v-if="person.length > 1">s</span></small>
                </div>
            ...
            <div class="d-flex flex-row form">
                <div class="pad">
                    <label for="toilet">Toilet Flushing</label><br>
                    <input type="text" v-model.number="toilet">liter(s)
                </div>
                <!-- <span class="equal">x</span> -->
                <div class="pad">
                    <label for="clean">General Cleaning</label><br>
                    <input type="text" v-model.number="clean">liter(s)
                </div>
                <!-- <span class="equal">=</span> -->
                <div class="pad">
                    <label for="garden">Gardening</label><br>
            ...
            <div class="flush d-flex flex-row">
                <div class="d-flex flex-row">
                    <div class="pad">
                        <label for="usagevol">Total Volume Per Day</label><br>
                        <input type="text" disabled :value="usagevol">liter
                    </div>
                    <div>
                        <label for="aveperson">Average Per Person</label><br>
            ...
            <button @click="next" class="btn btn-success" style="margin-top: 20px; font-weight:bold;">Run Simulation</button>
        </div>
    </div>
</template>
<script>
