    ...
    <div>
        <div class="container">
            ...
            <div class="row d-flex flex-column roof-detail">
                ...
                <div class="changeForm d-flex align-items-center">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control text-right" v-model="radius">
                        <div class="input-group-append">
...
<script>
    export default {
        ...
        computed: {
            ffpipe() {
                var value = this.firstflush / ((22 * this.radius ** 2) / 7);
