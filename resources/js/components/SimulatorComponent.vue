    ...
    <div>
        <div class="container">
            ...
            <div class="row d-flex justify-content-center">
                <button @click="simulate" class="btn btn-success mr-2" style="margin-top: 20px; font-weight:bold;" v-if="sButton">Run
                    Simulation</button>
                <!-- <router-link :to="{name: 'root'}" class="btn btn-success" style="margin-top: 20px; font-weight:bold;"
                    v-if="!sButton">Start Over?</router-link> -->
                <button @click="next" class="btn btn-success" style="margin-top: 20px; font-weight:bold;">Continue</button>
            </div>
            <div class="row d-flex justify-content-center">
                <router-link :to="{name: 'average'}" class="btn btn-success mr-2" style="margin-top: 20px; font-weight:bold;">More Info</router-link>
                <!-- <router-link :to="{name: 'root'}" class="btn btn-success" style="margin-top: 20px; font-weight:bold;"
                    v-if="!sButton">Start Over?</router-link> -->
            </div>
            <br><br>
    ...
    export default {
      ...
      methods: {
        ...
        simulate() {
          ...
          axios
            .post("http://localhost:8000/api/calc", data)
            .then(response => {
              //this.sButton = false;
