<template>
    <div class="container h-100">
        <div class="row h-100 d-flex align-items-center justify-content-center pt-5">
            <div class="col-md-8">
                <LMap ref="map" style="height:400px ; width: 640px" :center="currentPosition" :zoom="zoom">
            ...
            <div class="col-md-4 d-flex flex-column align-items-center justify-content-center rain">
                ...
                <select class="form-control" v-model="loc">
                    <option v-for="(value, key) in locations" :key="key">{{ value }}</option>
                </select>
                <button @click="next" class="btn btn-success" style="margin-top: 20px; font-weight:bold;">Roof
